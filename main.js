var body = document.querySelector("body"), // Creates a variable called body, so we can reference it more easily below.
  goLight = function() { // Creates a function called goLight that adds the '' class to the body wich should make it all light (or unstyled)
    body.className = "";
  },
...
// ____________________THIS MIGHT BE NEEDED TO MAKE IT WORK______________
